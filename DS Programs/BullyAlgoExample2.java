    ...
    {  
        ...
        {  
            ...
            {  
                ...
                {  
                    System.out.println("Process "+idOfInitiator+" passes election message to process " +i);  
            ...
            {  
                ...
                {  
                    if(processes[i].status == "active")
                    {  
                        System.out.println("Process "+i+" passes Ok message to process " +idOfInitiator);  
                    }  
            ...
            {  
                ...
                {  
                    if(processes[i].status == "active")
                    {  
                        System.out.println("Process "+coord+" passes coordinator message to process " +i);  
                    }  
                }  
